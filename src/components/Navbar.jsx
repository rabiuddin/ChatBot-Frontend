                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        <button
                            ...
                            className="px-4 py-2 rounded-lg bg-gray-300 dark:bg-gray-700 text-gray-800 dark:text-white transition duration-300 ease-in-out transform hover:scale-[1.03] hover:bg-gray-400 dark:hover:bg-gray-600 "
                        >
